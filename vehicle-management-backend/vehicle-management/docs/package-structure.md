...
- Supporting tables such as `iam.account_status_history`, `iam.role_permissions`, and `operations.shift_assignments` should live inside the nearest owning feature instead of becoming separate top-level modules.
