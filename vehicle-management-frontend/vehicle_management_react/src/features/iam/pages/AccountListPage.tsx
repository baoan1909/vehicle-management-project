...
export function AccountListPage() {
  return (
    <AdminTablePage
      ...
      columns={columns}
      rows={accounts}
      filters={<FilterControls selects={[{ name: "isActive", placeholder: "Tất cả", options: [{ label: "Đang hoạt động", value: "1" }, { label: "Đã bị khóa", value: "0" }] }]} />}
      actions={<div className="form-group col-2 ml-auto mr-3"><a href="#/admin/account/form" className="btn btn-info btn-block"><i className="fas fa-plus-circle" /> Thêm mới</a></div>}
    />
  );
}
