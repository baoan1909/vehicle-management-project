...
export function LostCardListPage() {
  return (
    <AdminTablePage
      ...
      actions={<div className="form-group col-2 ml-auto mr-3"><a href="#/admin/lost/form" className="btn btn-info btn-block"><i className="fas fa-plus-circle" /> Thêm mới</a></div>}
    />
  );
}
