...
export function CustomerListPage() {
  return (
    <AdminTablePage
      ...
      columns={columns}
      rows={customers}
      filters={<FilterControls selects={[{ name: "vehicleTypeId", placeholder: "Tất cả loại xe", options: vehicleTypes }, { name: "ticketTypeId", placeholder: "Tất cả loại vé", options: ticketTypes }]} />}
      actions={<div className="form-group col-2 ml-auto mr-3"><a href="#/admin/customer/form" className="btn btn-info btn-block"><i className="fas fa-plus-circle" /> Thêm mới</a></div>}
    />
  );
}
