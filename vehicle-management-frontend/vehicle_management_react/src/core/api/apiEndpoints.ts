...
modelConfigurations: "/ai/models/configurations",
  ...
  parking: {
    gates: "/parking/gates",
    lanes: "/parking/lanes",
    parkingLocationReverse: "/parking/locations/reverse",
    parkingLocationSearch: "/parking/locations/search",
    ocrLicensePlate: "/parking/ocr/license-plate",
    parkingLots: "/parking/parking-lots",
    parkingLotActivationRequest: (parkingLotId: string) => `/parking/parking-lots/${parkingLotId}/activation-request`,
